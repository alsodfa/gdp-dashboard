...
if 'selected_player' in locals():
    try:
        image = Image.open("/mnt/data/39ebc047-b5d6-4b73-8e9a-ec52d898639e.png")  # 실제 사진 경로 사용
